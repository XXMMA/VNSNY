...
to make-decisions
  ...
  foreach table:keys pop-ratio-each-type [this-type ->
    ...
    let wa_f max (list random-normal mu sigma 0)
    ;let ws_f max (list random-normal mu sigma 0)
    let we_f max (list random-normal mu sigma 0)
